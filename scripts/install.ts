...
const ensureDirectoriesExist = (directories: string[]) => {
  directories.forEach(dir => {
...
installDotfile(
  `${options.dotRoot}/submodules/zsh-autosuggestions`,
  `${process.env.HOME}/.oh-my-zsh/plugins/zsh-autosuggestions`,
  null,
  'dir'
)
installDotfile(
  `${options.dotRoot}/submodules/zsh-syntax-highlighting`,
  `${process.env.HOME}/.oh-my-zsh/plugins/zsh-syntax-highlighting`,
  null,
  'dir'
)
installDotfile(
  `${options.dotRoot}/bat`,
  `${process.env.HOME}/.config/bat`,
  null,
  'dir'
)
installDotfile(
  `${options.dotRoot}/tmux.conf`,
  `${process.env.HOME}/.tmux.conf`,
  null,
  'file'
)
installDotfile(
  `${options.dotRoot}/rsync-excludes`,
  `${process.env.HOME}/.rsync-excludes`,
  null,
  'file'
)
installDotfile(
  `${options.dotRoot}/git/gitconfig`,
